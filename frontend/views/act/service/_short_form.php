                ...
                <td colspan="5">
                    ...
                    <?php if(isset($partsPartnerScopes)) {
                        ...
                        foreach ($partsPartnerScopes as $scope) {?>
                            <div class="form-group" style="height: 25px;">
                                ...
                                <div class="col-xs-1">
                                    <?= Html::input('text', "Act[serviceList][$scope->id][price]", (isset($scope->price)) ? $scope->price : 0, ['class' => 'form-control input-sm parts-price', 'placeholder' => 'Цена']) ?>
                                </div>
                                <div class="col-xs-2">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group" style="height: 25px;">
                            ...
                            <div class="col-xs-1">
                                <?= Html::input('text', "Act[serviceList][71][price]", 0, ['class' => 'form-control input-sm parts-price', 'placeholder' => 'Цена']) ?>
                            </div>
                            <div class="col-xs-2">
                ...
                <td colspan="5">
                    ...
                    <?php if(isset($partnerScopes)) {
                        ...
                        foreach ($partnerScopes as $scope) {
                            ...
                            <div class="form-group" style="height: 25px;">
                                ...
                                <div class="col-xs-1">
                                    <?= Html::input('text', "Act[serviceList][$scope->id][price]", (isset($scope->price)) ? $scope->price : 0, ['class' => 'form-control input-sm scope-price', 'placeholder' => 'Стоимость']) ?>
                                </div>
                                <div class="col-xs-2">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group" style="height: 25px;">
                            ...
                            <div class="col-xs-1">
                                <?= Html::input('text', "Act[serviceList][0][price]", 0, ['class' => 'form-control input-sm scope-price', 'placeholder' => 'Стоимость']) ?>
                            </div>
                            <div class="col-xs-2">
