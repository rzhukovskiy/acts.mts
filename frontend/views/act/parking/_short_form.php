            ...
            <tr>
                <td colspan="5">
                    <div class="form-group" style="height: 5px;">
                        ...
                        <div class="col-xs-2">
                            <label class="control-label">Количество суток</label>
                        </div>
                        <div class="col-xs-2">
                    ...
                    <?php if(isset($partnerScopes)) {
                        ...
                        foreach ($partnerScopes as $scope) {
                            ...
                            <div class="form-group" style="height: 25px;">
                                ...
                                <div class="col-xs-2">
                                    <?= Html::input('text', "Act[serviceList][$scope->id][amount]", (isset($scope->amount)) ? $scope->amount : 1, ['class' => 'not-null form-control input-sm', 'placeholder' => 'Количество']) ?>
                                </div>
                                <div class="col-xs-2">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group" style="height: 25px;">
                            ...
                            <div class="col-xs-2">
                                <?= Html::input('text', "Act[serviceList][0][amount]", 1, ['class' => 'not-null form-control input-sm', 'placeholder' => 'Количество']) ?>
                            </div>
                            <div class="col-xs-2">
