            ...
            'columns' => [
                ...
                [
                    ...
                    'content' => function ($data) {
                        ...
                        return Html::a($date, ['/stat/month', 'id' => $data->client->id, 'date' => $data->dateMonth]);
                    }
                ],
                [
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            return Html::a('<span class="glyphicon glyphicon-search"></span>', ['/stat/month', 'id' => $model->client->id, 'date' => $model->dateMonth]);
                        }
                    ]
                ],
            ]
