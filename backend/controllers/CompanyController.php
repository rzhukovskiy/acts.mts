    ...
    {
        {
            ...
            // Возвратные
            if ($type == 1) {
                $dataProvider->query->where(['OR', ['purchase_status' => 21], ['purchase_status' => 22]])->groupBy('user_id')->select(['user_id', 'federal_law' => 'count(user_id)']);
                // Невозвратные
            } else {
                $dataProvider->query->where(['OR', ['purchase_status' => 16], ['purchase_status' => 17], ['purchase_status' => 20], ['purchase_status' => 23]])->groupBy('user_id')->select(['user_id', 'federal_law' => 'count(user_id)']);
            }
