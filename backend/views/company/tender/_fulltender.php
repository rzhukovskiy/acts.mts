...
?>
    ...
    <div class="panel-heading">
        ...
        <div class="header-btn pull-right">
            <?= Html::a('Добавить задачу', ['plan/taskadd', 'id' => $model->id], ['target'=>'_blank', 'class' => 'btn btn-success btn-sm']) . '<span class="btn btn-warning btn-sm listSettings" style="margin-left:10px;">Управление списками</span>' ?>
        </div>
    </div>
