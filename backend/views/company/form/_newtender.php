...
<?= $form->field($model, 'final_price')->input('text', ['class' => 'form-control', 'placeholder' => 'Введите окончательную цену контракта']) ?>
<?= $form->field($model, 'pre_income')->input('text', ['class' => 'form-control', 'placeholder' => 'Введите предварительную прибыль от контраката']) ?>
...
<?= $form->field($model, 'participate_price')->input('text', ['class' => 'form-control', 'placeholder' => 'Введите стоимость участия в торгах']) ?>
