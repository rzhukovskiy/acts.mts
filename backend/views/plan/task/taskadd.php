...
$script = <<< JS
   ...
   $('.field-taskuser-for_user div').html('<input id="searchText" style="display: none; margin-bottom: 20px;" type="text" class="form-control" name="searchText" placeholder="Поиск пользователя">' + $('.field-taskuser-for_user div').html());
