...
class Company extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['status', 'in', 'range' => [self::STATUS_REFUSE, self::STATUS_ARCHIVE, self::STATUS_ARCHIVE2, self::STATUS_ACTIVE, self::STATUS_DELETED, self::STATUS_NEW]],
        ];
    }
